...
<head>
  ...
  <link rel="stylesheet" href="/themes/cart/ogmiao/v10/css/common_product.css">
...
<body>
                ...
                <el-option v-for="items in item.subs" :key='items.os' :value="items.os" :label="items.os">
                  <div class="option-label">
                    <img class="option-img"
                      :src="'/themes/cart/ogmiao/v10/assets/' + items.os.toLowerCase() + '.svg'"
                      alt="">
  ...
  <script src="/themes/cart/ogmiao/v10/components/customGoods/customGoods.js"></script>
  <!-- 独有 -->
  <script src="/themes/cart/ogmiao/v10/api/common_product.js"></script>
  <script src="/themes/cart/ogmiao/v10/js/common_product.js"></script>
</body>
</html>
