...
<head>
  ...
  <title></title>
  <link rel="stylesheet" href="/themes/cart/ogmiao/v10/resource/element.css">
  <link rel="stylesheet" href="/themes/cart/ogmiao/v10/css/mf_cloud.css">
  <script src="/themes/cart/ogmiao/v10/lang/{$LanguageCheck.display_flag}.js"></script>
</head>
<body>
                  ...
                  <div class="cloud-item" :class="{active: index=== cloudIndex}" v-for="(item,index) in recommendList"
                    ...
                    <p class="no-up" v-if="item.upgrade_range === 0 && baseConfig.no_upgrade_tip_show === 1">
                      <el-tooltip class="item" effect="dark" :content="lang.no_upgrade" placement="bottom"
                        ...
                        <img src="/themes/cart/ogmiao/v10/img/no-upgrade.svg" alt="">
                      </el-tooltip>
                    </p>
                  </div>
                </div>
                ...
                <div class="image-box">
                  <div class="image-ul">
                    <div class="image-item" v-for="(item,index) in calcImageList" :key="item.id"
                      ...
                      <img :src="`/themes/cart/ogmiao/v10/img/${item.icon}.svg`" alt="" class="icon" />
                      <div class="r-info">
                      ...
                      <el-form-item label=" ">
                        <p class="s-tip jump-box">{{lang.mf_tip17}}&nbsp;&nbsp;
                          <a href="security_ssh.htm" target="_blank" class="add-ssh">
                            {{lang.mf_tip18}}
                            <img src="/themes/cart/ogmiao/v10/img/jump.svg" alt="" class="icon">
                          </a>
                        </p>
                      </el-form-item>
                    </template>
            ...
            <div class="bot-price" v-loading="loadingPrice">
              ...
              <div class="old">
                ...
                <el-popover placement="top" trigger="click" popper-class="discount-pup" v-model="dis_visible"
                  v-if="!discount">
                  <div class="discount">
                    <img src="/themes/cart/ogmiao/v10/img/close_icon.png" alt="" class="close"
  ...
  <!-- 通用 -->
  <script src="/themes/cart/ogmiao/v10/resource/vue.js"></script>
  <script src="/themes/cart/ogmiao/v10/resource/element.js"></script>
  <script src="/themes/cart/ogmiao/v10/utils/axios.min.js"></script>
  <script src="/themes/cart/ogmiao/v10/utils/request.js"></script>
  <script src="/themes/cart/ogmiao/v10/utils/util.js"></script>
  <script src="/themes/cart/ogmiao/components/customGoods/customGoods.js"></script>
  <!-- 独有 -->
  <script src="/themes/cart/ogmiao/v10/api/mf_cloud.js"></script>
  <script src="/themes/cart/ogmiao/v10/js/mf_cloud.js"></script>
</body>
</html>
